  ...
  const renderitem = ({ item }) => {
    return (
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate("News Detail", { itemId: item.id })} // Mengirim itemId sebagai parameter
      >
        <Box
          p={"4"}
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() =>
                  ...
                  navigation.navigate("News Detail", { itemId: item.id }) // Mengirim itemId sebagai parameter
                }
              >
